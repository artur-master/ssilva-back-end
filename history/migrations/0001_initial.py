# Generated by Django 2.1.2 on 2019-01-30 16:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('BorradorPromesaState', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historical_estado_borrador_promesa_proyecto', to='empresas_and_proyectos.BorradorPromesaState')),
                ('ComunaID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historical_comuna_proyecto', to='common.Comuna')),
                ('ConstructoraID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historical_constructora_proyecto', to='empresas_and_proyectos.Constructora')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historical_estado_ingreso_comisiones_proyecto', to='empresas_and_proyectos.IngresoComisionesState'),
        ),
        migrations.AddField(
            model_name='historicalproyecto',
            name='InmobiliariaID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historical_inmobiliaria_proyecto', to='empresas_and_proyectos.Inmobiliaria'),
        ),
        migrations.AddField(
            model_name='historicalproyecto',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historical_estado_plan_medios_proyecto', to='empresas_and_proyectos.PlanMediosState'),
        ),
        migrations.AddField(
            model_name='historicalproyecto',
