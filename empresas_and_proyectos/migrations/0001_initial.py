    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('GuaranteeAmount', models.IntegerField()),
                ('MoreThanOneEtapa', models.BooleanField(default=False)),
                ('MoreThanOneEdificio', models.BooleanField(default=False)),
                ('BorradorPromesaState', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='estado_borrador_promesa_proyecto', to='empresas_and_proyectos.BorradorPromesaState')),
                ('ComunaID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comuna_proyecto', to='common.Comuna')),
                ('ConstructoraID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='constructora_proyecto', to='empresas_and_proyectos.Constructora')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='proyecto',
            name='IngresoComisionesState',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='estado_ingreso_comisiones_proyecto', to='empresas_and_proyectos.IngresoComisionesState'),
        ),
        migrations.AddField(
            model_name='proyecto',
            name='InmobiliariaID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inmobiliaria_proyecto', to='empresas_and_proyectos.Inmobiliaria'),
        ),
        migrations.AddField(
            model_name='proyecto',
        ...
        migrations.AddField(
            model_name='proyecto',
            name='PlanMediosState',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='estado_plan_medios_proyecto', to='empresas_and_proyectos.PlanMediosState'),
        ),
        migrations.AddField(
            model_name='proyecto',
            name='ProyectoApprovalState',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='estado_aprobacion_proyecto', to='empresas_and_proyectos.ProyectoApprovalState'),
        ),
        migrations.AddField(
            model_name='proyecto',
